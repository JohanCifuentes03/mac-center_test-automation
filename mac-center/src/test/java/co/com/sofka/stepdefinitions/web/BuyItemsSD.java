...
import co.com.sofka.tasks.AddItemToCart;
import co.com.sofka.tasks.OpenCart;
import co.com.sofka.tasks.OpenMain;
import co.com.sofka.tasks.SearchItem;
...
public class BuyItemsSD extends WebSetup{
    ...
    public void confirmsTheirCredentials() {
